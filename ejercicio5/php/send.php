<?php
    ...
    $phpmailer->AddAddress( 'juanantoniotorres510@gmail.com', 'Juan Torres' );  // Correo del destinatario y nombre
    ...
    $phpmailer->Username   = 'juan@sfumino.mx';                       // Usuario del correo electrónico
    $phpmailer->Password   = '$Juan_01*';                               // Contraseña del correo electrónico
    $phpmailer->From       = 'juan@sfumino.mx';                       // From
